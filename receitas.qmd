...
Neste projteto nós vamos aboradar os dados da receita pública disponíveis em [dados abertos](https://portaldatransparencia.gov.br/download-de-dados).
...
Os arquivos csv para os exercícios de 2013 e 2015 atribuem a data 31/12 para todos os lançamentos. A @tbl-data_lancamento_2015 apresenta a única data (31/12/2015) da base de dados do exercíco de 2015.
...
\
Segui a dica do Steves Ross ([Como remover caracteres especiais no R](https://rstudio-pubs-static.s3.amazonaws.com/596043_34a6208249e14b2c850cd482b47aab10.html)) para remover os caracteres especiais e o atibuto *detalhamento* deixou de ter, por exemplo, acentos e cedilha.
...
#| tbl-cap: Detalhamento da receita - inconsitência no nome.
...
O Tipo da receita segue a estrutura apresentada na @fig-receita_tipo, contudo a base de dados não traz os códigos da receita. Eu tentei idenficar os tipos a partir dos nomes contidos no detalhamento da receita. Para simplificar, ao invés de cinco códigos (0 ao 4), eu apliquei apenas três códigos: 01 - Principal, 02 - Intra e 03 - Dívida Ativa, Multas e Juros.
...
A @tbl-dividendos apresenta o valor previsto, o realizado e o resultdado da arrecadação de dividendos por parte da União. Ressaltamos os que dividendos recebidos estão relacionados à quantidade de estatais, à participação da União das estatais, ao lucro da estatais e à política de dividendos das estatais.
